  ...
  return (
    <div className="grain min-h-[100dvh] bg-background">
      ...
      <main className="md:ml-[238px]">
          <header className="border-b border-border/70 px-4 py-4 sm:px-5 sm:py-5 md:px-10 md:py-7">
          <div className="flex items-center justify-between gap-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[.16em] text-muted-foreground">Personal ledger</p>
               <h1 className="mt-1 font-serif text-2xl tracking-tight sm:text-3xl md:text-4xl">
              ...
              {list.isLoading ? (
                ...
                <div>
                  {visible.slice(0, 8).map((expense) => (
                     <div key={expense.id} data-testid={`row-expense-${expense.id}`} className="group flex min-w-0 items-center gap-3 border-b px-4 py-4 last:border-0 md:px-6">
      ...
      {showForm && (
         <div className="fixed inset-0 z-30 grid items-end bg-primary/20 p-2.5 backdrop-blur-sm sm:items-center sm:p-5">
           <div className="w-[95vw] max-w-md rounded-2xl border bg-card p-5 shadow-lg sm:mx-auto sm:p-6">
